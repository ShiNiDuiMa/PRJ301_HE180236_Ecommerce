...
<%-- 
    ...
    Created on : Mar 16, 2024, 12:43:37 AM
    Author     : Hoangvan
--%>
                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="home" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Home</span></a>						
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="o" items="${requestScope.listP}" >
                                <tr>
                                    ...
                                    <td>${o.price}</td>
                                    <td>
                                        <a href="load?pid=${o.id}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                ...
                <div class="modal-content">
                    <form action="load">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Image</label>
                                <input value="${detail.image}" name ="image" type="url" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Price</label>
                            ...
                            <div class="form-group">
                                <label>Description</label>
                                <input value="${detail.description}" name="des" type="text" class="form-control" required>
                            </div>	
                            <div class="form-group">
                                <label>Brand</label>
                                <select name="brand">
