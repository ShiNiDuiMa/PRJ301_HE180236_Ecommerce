...
<!--                <div class="carousel-indicators">
                ...
                <div class="carousel-inner" >
                    <div class="carousel-item active" style="height: 600px;">
                        <img src="https://t4.ftcdn.net/jpg/06/20/21/89/360_F_620218921_4D77gJm15ri5DIUSfRKbDpYHtwM5ndUK.jpg" class="d-block w-100" alt="Wild Landscape"/>
                        <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)"></div>
                        <div class="carousel-caption d-none d-sm-block mb-5">
                            <h1 class="mb-4">
                                <strong>Explore the art of fragrance with Emufrep</strong>
                            </h1>

                            <p>
                                <strong>Find yourself a distinctive fragrance</strong>
                            </p>
